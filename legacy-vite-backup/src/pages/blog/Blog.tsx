...
export default function Blog() {
  ...
  const filtered = activeFilter === 'All Posts'
    ? blogPosts
    : blogPosts.filter((p) => p.filterCategory === activeFilter);

  return (
    <AuthGuard>
      <SeoHead
        title="Blog"
        description="Build logs, research breakdowns, and tool drops — written by someone actually shipping AI projects, not just talking about it."
        path="/blog"
      />
