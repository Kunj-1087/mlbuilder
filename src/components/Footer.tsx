          ...
          <div className="grid grid-cols-2 md:grid-cols-6 gap-8 md:gap-10">
            ...
            <div>
              ...
              <ul className="space-y-2.5">
                <li>
                  <Link to="/automation/workflows" className="font-body text-sm text-cream/60 hover:text-accent transition-colors">
                    Automation
                  </Link>
                </li>
                <li>
                  <Link to="/research/papers" className="font-body text-sm text-cream/60 hover:text-accent transition-colors">
                    Research
                  </Link>
                </li>
                <li>
                  <Link to="/tools/free" className="font-body text-sm text-cream/60 hover:text-accent transition-colors">
                    Tools
                  </Link>
                </li>
                <li>
                  <Link to="/blog" className="font-body text-sm text-cream/60 hover:text-accent transition-colors">
                    Blog
                  </Link>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-2.5">
                <li>
                  <Link to="/sign-in" className="font-body text-sm text-cream/60 hover:text-accent transition-colors">
                    Sign In
                  </Link>
                </li>
                <li>
                  <Link to="/sign-up" className="font-body text-sm text-cream/60 hover:text-accent transition-colors">
                    Create Account
                  </Link>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-2.5">
                <li>
                  <Link to="/free" className="font-body text-sm text-cream/60 hover:text-accent transition-colors">
                    Free Downloads
                  </Link>
                </li>
                <li>
                  <Link to="/newsletter" className="font-body text-sm text-cream/60 hover:text-accent transition-colors">
                    Newsletter
                  </Link>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-2.5">
                <li>
                  <Link to="/privacy" className="font-body text-sm text-cream/60 hover:text-accent transition-colors">
                    Privacy Policy
                  </Link>
                </li>
                <li>
