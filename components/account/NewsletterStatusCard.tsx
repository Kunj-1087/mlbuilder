...
export default function NewsletterStatusCard({
  ...
  const handleResend = async () => {
    ...
    setResending(false);
    setResendMsg('Confirmation resent â€” check your inbox.');
  };
    ...
    return (
      <div className="border-2 border-ink rounded-sharp bg-cream shadow-hard p-8">
        <div className="flex items-center justify-between mb-4">
          <span className="font-display text-[32px] text-accent">SUBSCRIBED âœ“</span>
  ...
  if (localStatus === 'PENDING') {
    return (
      <div className="border-2 border-ink rounded-sharp bg-cream shadow-hard p-8">
        ...
        <p className="font-script text-ink text-[18px] mb-2">
          Check your inbox â€” I sent a confirmation link.
        </p>
        {createdAt && (
