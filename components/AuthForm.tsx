        ...
        <div className="bg-surface border-2 border-ink rounded-sharp shadow-hard p-8 md:p-10">
            ...
            <div>
              ...
              {mode === 'sign-in' && (
                <div className="text-right">
                  <Link href="/forgot-password" className="font-body text-muted text-xs hover:text-accent transition-colors">
                    Forgot password?
                  </Link>
                </div>
              )}
          ...
          <div className="mt-6 pt-5 border-t-2 border-ink/10 text-center">
            <p className="font-body text-muted text-sm">
              {c.bottomText}{' '}
              <Link href={`${c.bottomTo}${searchString}`} className="text-accent font-semibold hover:text-ink transition-colors">
                {c.bottomLink}
              </Link>
            </p>
          </div>
