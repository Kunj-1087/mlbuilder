    ...
    return (
      ...
      >
        ...
        <p className="font-body text-muted text-sm">
          Already subscribed? You're still good â€” same email, no duplicates.
        </p>
      </div>
    );
  }
    ...
    >
      ...
      <form onSubmit={handleSubmit} className="space-y-3">
        ...
        <button
          ...
          "
        >
          {loading ? (<>Sending <InlineSpinner size="sm" color="ink" className="ml-2" /></>) : 'Send Me The PDF â†’'}
        </button>
      </form>
      ...
      <p className="font-body text-muted text-[11px] mt-4 leading-relaxed">
        ...
        Unsubscribe anytime â€” one click.
      </p>
    </div>
  );
}
